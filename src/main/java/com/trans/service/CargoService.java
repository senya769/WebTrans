...
public interface CargoService {
    ...
    //    Page<Cargo> searchByArgs(String keyword,String countryFrom, String countryTo,String cityFrom, String cityTo,
//                             double price,double volume,double weight, int page);
    Page<Cargo> searchByArgs(int page, Object... objects);
}
